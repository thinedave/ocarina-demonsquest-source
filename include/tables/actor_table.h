...
/* 0x01D7 */ DEFINE_ACTOR(Savespot, ACTOR_SAVESPOT, ACTOROVL_ALLOC_NORMAL, "Savespot")
/* 0x01D7 */ DEFINE_ACTOR(XPDrop, ACTOR_XPDROP, ACTOROVL_ALLOC_NORMAL, "XPDrop")
DEFINE_ACTOR(BgGanonLadder, ACTOR_BG_GANON_LADDER, ACTOROVL_ALLOC_NORMAL, "BgGanonLadder")
DEFINE_ACTOR(En_Ganon_Sword, ACTOR_EN_GANON_SWORD, ACTOROVL_ALLOC_NORMAL, "EnGanonSword")
DEFINE_ACTOR(Notice, ACTOR_NOTICE, ACTOROVL_ALLOC_NORMAL, "BgNotice")
DEFINE_ACTOR(DemonsDoor, ACTOR_DEMONSDOOR, ACTOROVL_ALLOC_NORMAL, "DemonsDoor")
DEFINE_ACTOR(PowerTrialHandler, ACTOR_POWERTRIAL_HANDLER, ACTOROVL_ALLOC_NORMAL, "PowerTrialHandler")
