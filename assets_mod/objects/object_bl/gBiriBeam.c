...
Vtx gBiriBeam_gBiriBeam_mesh_layer_Transparent_vtx_cull[8] = {
...
Vtx gBiriBeam_gBiriBeam_mesh_layer_Transparent_vtx_0[20] = {
...
Gfx mat_gBiriBeam_f3dlite_material_layerTransparent[] = {
...
Gfx gBiriBeam[] = {
	...
	gsSPVertex(gBiriBeam_gBiriBeam_mesh_layer_Transparent_vtx_cull + 0, 8, 0),
	gsSPSetGeometryMode(G_LIGHTING),
	gsSPCullDisplayList(0, 7),
	gsSPDisplayList(mat_gBiriBeam_f3dlite_material_layerTransparent),
	gsSPDisplayList(gBiriBeam_gBiriBeam_mesh_layer_Transparent_tri_0),
	gsSPEndDisplayList(),
};
