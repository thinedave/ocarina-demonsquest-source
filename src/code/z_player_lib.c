...
// {???, ???, ???, ???, min walk anim speed, max walk anim speed, ???, normal run anim speed, decel speed, max run speed, grav multiplier, ???, ???, ???, jump strength, ???, ???, ???}

s16 sBootData[PLAYER_BOOTS_MAX][17] = {
    { 200, 1000, 300, 700, 550, 270, 600,  350, 800, 600, -100, 600, 590, 750, 125, 200, 130 }, // kokiri
    ...
    { 200, 1000, 300, 800, 500, 400, 800,  400, 800, 550, -100, 600, 540, 750, 125, 400, 200 }, // kokiri child
};
...
Color_RGB8 sTunicColors[PLAYER_TUNIC_MAX] = {
    { 59, 99, 57 }, // PLAYER_TUNIC_KOKIRI
    { 99, 45, 32 },  // PLAYER_TUNIC_GORON
    { 40, 75, 99 },  // PLAYER_TUNIC_ZORA
};
