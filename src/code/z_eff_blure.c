...
void EffectBlure_DrawElemHermiteInterpolation(EffectBlure* this, EffectBlureElement* elem, s32 index,
    ...
    if (vtx == NULL) {
        ...
        for (i = 1; i < 8; i++) {
            ...
            vtx[j1].v.color[0] = EffectSs_LerpU8(sp1A4.r, sp19C.r, temp_f28);
            vtx[j1].v.color[1] = EffectSs_LerpU8(sp1A4.g, sp19C.g, temp_f28);
            vtx[j1].v.color[2] = EffectSs_LerpU8(sp1A4.b, sp19C.b, temp_f28);
            vtx[j1].v.color[3] = EffectSs_LerpU8(sp1A4.a, sp19C.a, temp_f28);
            ...
            vtx[j2].v.color[0] = EffectSs_LerpU8(sp1A0.r, sp198.r, temp_f28);
            vtx[j2].v.color[1] = EffectSs_LerpU8(sp1A0.g, sp198.g, temp_f28);
            vtx[j2].v.color[2] = EffectSs_LerpU8(sp1A0.b, sp198.b, temp_f28);
            vtx[j2].v.color[3] = EffectSs_LerpU8(sp1A0.a, sp198.a, temp_f28);
        }
            ...
            if (vtx == NULL) {
                ...
                for (i = 0; i < this->numElements; i++) {
                    ...
                    if (elem->state == 1) {
                        ...
                        switch (this->calcMode) {
                            case 1:
                                vtx[j].v.vector[0] = EffectSs_LerpS16(elem->p1.x, elem->p2.x, ratio);
                                vtx[j].v.vector[1] = EffectSs_LerpS16(elem->p1.y, elem->p2.y, ratio);
                                vtx[j].v.vector[2] = EffectSs_LerpS16(elem->p1.z, elem->p2.z, ratio);
                            ...
                            case 2:
                                ...
                                vtx[j + 1].v.vector[0] = EffectSs_LerpS16(elem->p2.x, elem->p1.x, ratio);
                                vtx[j + 1].v.vector[1] = EffectSs_LerpS16(elem->p2.y, elem->p1.y, ratio);
                                vtx[j + 1].v.vector[2] = EffectSs_LerpS16(elem->p2.z, elem->p1.z, ratio);
                                break;
                            case 3:
                                ratio = ratio * 0.5f;
                                vtx[j].v.vector[0] = EffectSs_LerpS16(elem->p1.x, elem->p2.x, ratio);
                        ...
                        vtx[j].v.tc[0] = 0;
                        vtx[j].v.tc[1] = 0;
                        vtx[j].v.color[0] = EffectSs_LerpU8(this->p1StartColor[0], this->p1EndColor[0], ratio);
                        vtx[j].v.color[1] = EffectSs_LerpU8(this->p1StartColor[1], this->p1EndColor[1], ratio);
                        vtx[j].v.color[2] = EffectSs_LerpU8(this->p1StartColor[2], this->p1EndColor[2], ratio);
                        vtx[j].v.color[3] = EffectSs_LerpU8(this->p1StartColor[3], this->p1EndColor[3], ratio);
                        j++;

                        vtx[j].v.flag = 0;
                        vtx[j].v.tc[0] = 0;
                        vtx[j].v.tc[1] = 0;
                        vtx[j].v.color[0] = EffectSs_LerpU8(this->p2StartColor[0], this->p2EndColor[0], ratio);
                        vtx[j].v.color[1] = EffectSs_LerpU8(this->p2StartColor[1], this->p2EndColor[1], ratio);
                        vtx[j].v.color[2] = EffectSs_LerpU8(this->p2StartColor[2], this->p2EndColor[2], ratio);
                        vtx[j].v.color[3] = EffectSs_LerpU8(this->p2StartColor[3], this->p2EndColor[3], ratio);
                        j++;
                    }
                }
