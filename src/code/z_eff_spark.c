...
void EffectSpark_Draw(void* thisx, GraphicsContext* gfxCtx) {
    ...
    if (this != NULL) {
        ...
        for (i = 0; i < this->numElements; i++) {
            ...
            vertices[j].v.vector[0] = -32;
            vertices[j].v.vector[1] = -32;
            vertices[j].v.vector[2] = 0;
            vertices[j].v.color[0] = sp1D3;
            vertices[j].v.color[1] = sp1D2;
            vertices[j].v.color[2] = sp1D1;
            vertices[j].v.color[3] = sp1D0;
            vertices[j].v.tc[0] = 0;
            vertices[j].v.tc[1] = 1024;
            vertices[j].v.flag = 0;

            vertices[j + 1].v.vector[0] = 32;
            vertices[j + 1].v.vector[1] = 32;
            vertices[j + 1].v.vector[2] = 0;
            vertices[j + 1].v.color[0] = sp1CF;
            vertices[j + 1].v.color[1] = sp1CE;
            vertices[j + 1].v.color[2] = sp1CD;
            vertices[j + 1].v.color[3] = sp1CC;
            vertices[j + 1].v.tc[0] = 1024;
            vertices[j + 1].v.tc[1] = 0;
            vertices[j + 1].v.flag = 0;

            vertices[j + 2].v.vector[0] = -32;
            vertices[j + 2].v.vector[1] = 32;
            vertices[j + 2].v.vector[2] = 0;
            vertices[j + 2].v.color[0] = sp1CB;
            vertices[j + 2].v.color[1] = sp1CA;
            vertices[j + 2].v.color[2] = sp1C9;
            vertices[j + 2].v.color[3] = sp1C8;
            vertices[j + 2].v.tc[0] = 0;
            vertices[j + 2].v.tc[1] = 0;
            vertices[j + 2].v.flag = 0;

            vertices[j + 3].v.vector[0] = 32;
            vertices[j + 3].v.vector[1] = -32;
            vertices[j + 3].v.vector[2] = 0;
            vertices[j + 3].v.color[0] = sp1C7;
            vertices[j + 3].v.color[1] = sp1C6;
            vertices[j + 3].v.color[2] = sp1C5;
            vertices[j + 3].v.color[3] = sp1C4;
