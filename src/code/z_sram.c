...
#define CURSED offsetof(SaveContext, save.info.demonsCurse)
#define DEAD offsetof(SaveContext, save.info.dead)
#define HEARTS_BLOCKED offsetof(SaveContext, save.info.heartsBlocked)
...
void Sram_InitDebugSave(void) {
    ...
    gSaveContext.save.info.playerData.magicLevel = 0;
    gSaveContext.save.info.sceneFlags[SCENE_WATER_TEMPLE].swch = 0x40000000;
    gSaveContext.save.info.savePoint = -1; // debug default save point
}
...
void Sram_InitSave(FileSelectState* fileSelect, SramContext* sramCtx) {
    ...
    gSaveContext.save.info.demonsCurse = fileSelect->wantsDemonsCurse;
    osSyncPrintf("gSaveContext.save.info.demonsCurse = %d, fileSelect->wantsDemonsCurse = %d\n", gSaveContext.save.info.demonsCurse, fileSelect->wantsDemonsCurse);
    ...
    //fileSelect->demonsCurses[gSaveContext.fileNum] = gSaveContext.save.info.demonsCurse;
