...
void Math3D_VtxF2L(Vtx* r, Vec3f* v) {
    r->n.vector[0] = Math_FFloorF(0.5f + v->x * 128.0f);
    r->n.vector[1] = Math_FFloorF(0.5f + v->y * 128.0f);
    r->n.vector[2] = Math_FFloorF(0.5f + v->z * 128.0f);
    r->n.flag = 0;
    r->n.tc[0] = 0;
    r->n.tc[1] = 0;
    r->n.n[0] = v->x * 127.0f;
...
void Math3D_DrawCylinderImpl(GraphicsContext* gfxCtx, Gfx** gfxP, f32 x, f32 y, f32 z, s16 radius, s16 height) {
    ...
    if (!pCylGfx) {
        ...
        cylVtx[0].n.vector[0] = 0;
        cylVtx[0].n.vector[1] = 0;
        cylVtx[0].n.vector[2] = 0;
        cylVtx[0].n.flag = 0;
        cylVtx[0].n.tc[0] = 0;
        cylVtx[0].n.tc[1] = 0;
        cylVtx[0].n.n[0] = 0;
        ...
        cylVtx[1].n.vector[0] = 0;
        cylVtx[1].n.vector[1] = 128;
        cylVtx[1].n.vector[2] = 0;
        cylVtx[1].n.flag = 0;
        cylVtx[1].n.tc[0] = 0;
        cylVtx[1].n.tc[1] = 0;
        cylVtx[1].n.n[0] = 0;
        ...
        for (i = 0; i < 12; ++i) {
            ...
            cylVtx[2 + i * 2 + 0].n.vector[0] = vtxX;
            cylVtx[2 + i * 2 + 0].n.vector[1] = 0;
            cylVtx[2 + i * 2 + 0].n.vector[2] = vtxZ;
            ...
            cylVtx[2 + i * 2 + 1].n.vector[0] = vtxX;
            cylVtx[2 + i * 2 + 1].n.vector[1] = 128;
            cylVtx[2 + i * 2 + 1].n.vector[2] = vtxZ;
